...
export const PLACES: Place[] = [
  {
    id: '1',
    name: { en: 'Great Mosque of Touggourt', ar: 'المسجد الكبير بتقرت' },
    description: { 
    ...
    location: {
      lat: 33.1064,
      lng: 6.0628,
      address: { en: 'Center of Touggourt, Algeria', ar: 'وسط مدينة تقرت، الجزائر' }
    },
    featured: true
  },
  {
    id: '2',
    name: { en: 'The Palmeraie of Touggourt', ar: 'واحات النخيل بتقرت' },
    description: {
    ...
    location: {
      lat: 33.1150,
      lng: 6.0750,
      address: { en: 'Oasis Region, Touggourt', ar: 'منطقة الواحات، تقرت' }
    },
    featured: true
  },
  {
    id: '3',
    name: { en: 'Zaouia of Tidjania', ar: 'الزاوية التجانية' },
    description: {
    ...
    location: {
      lat: 33.1000,
      lng: 6.0600,
      address: { en: 'Tamacine, Near Touggourt', ar: 'تماسين، بالقرب من تقرت' }
    }
  },
  {
    id: '4',
    name: { en: 'Hotel Oasis', ar: 'فندق الواحات' },
    description: {
    ...
    location: {
      lat: 33.1080,
      lng: 6.0650,
      address: { en: 'Main Road, Touggourt', ar: 'الطريق الرئيسي، تقرت' }
    }
  },
  {
    id: '5',
    name: { en: 'Restaurant Le Sahara', ar: 'مطعم الصحراء' },
    description: {
    ...
    location: {
      lat: 33.1070,
      lng: 6.0640,
      address: { en: 'Commercial District, Touggourt', ar: 'الحي التجاري، تقرت' }
    }
  }
];
