...
export const translations: TranslationDict = {
  ...
  historyDetails: {
    en: 'With roots reaching back to the 15th century, it was the historic capital of the Sultanate of Touggourt. It is famous for its vast palm groves and the spiritual center of Tamacine.',
  ...
  autoTranslating: { en: 'AI Translating...', ar: 'الذكاء الاصطناعي يترجم...', fr: 'Traduction IA...' },
  ...
  heritageTitle: { en: 'Heritage & Traditions', ar: 'التراث والتقاليد', fr: 'Héritage et Traditions' },
  heritageIndustries: { en: 'Traditional Industries', ar: 'الصناعات التقليدية', fr: 'Industries Traditionnelles' },
  heritageClothing: { en: 'Traditional Clothing', ar: 'اللباس التقليدي', fr: 'Vêtements Traditionnels' },
  heritageCulinary: { en: 'Culinary Arts', ar: 'فن الطبخ', fr: 'Arts Culinaires' },
  heritageFolklore: { en: 'Folklore & Music', ar: 'الفلكلور والموسيقى', fr: 'Folklore et Musique' },
  heritageFestivals: { en: 'Events & Festivals', ar: 'المهرجانات والفعاليات', fr: 'Événements et Festivals' },
